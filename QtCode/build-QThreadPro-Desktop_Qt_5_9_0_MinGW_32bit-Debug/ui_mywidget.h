...
public:
    ...
    void retranslateUi(QWidget *MyWidget)
    {
        ...
        buttonClose->setText(QApplication::translate("MyWidget", "stop", Q_NULLPTR));
    } // retranslateUi
